	...
	public class UnitSensorView
	{
		...
		private void UpdateVisibilityState()
		{
			...
			if (MapModManager.EnableEnemySensors)
			{
				...
				Color b = new Color(0.0431372561f, 0.0431372561f, 0.149019614f);
				if (!this.IsFriendly)
				{
					Color a = new Color(0.360784322f, 0f, 0.7176471f);
					Color a2 = new Color(0.396078438f, 0.211764708f, 0.733333349f);
					component.material = UnitSensorView.redMaterial;
					component.material.SetColor("_Color", a - b);
					component.material.SetColor("_IntersectColor", a2 - b);
				}
				else
				{
					Color a3 = new Color(0f, 0.003921569f, 0.7176471f);
					Color a4 = new Color(0.211764708f, 0.372549027f, 0.733333349f);
					component.material = UnitSensorView.blueMaterial;
					component.material.SetColor("_Color", a3 - b);
					component.material.SetColor("_IntersectColor", a4 - b);
				}
			}
			// MOD
		...
		// MOD
		private static Material blueMaterial = new Material(UnitSensorView.makeShader(1));

		private static Material redMaterial = new Material(UnitSensorView.makeShader(4));
		// MOD
